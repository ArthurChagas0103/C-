...
namespace salarioFuncionario2
{
    public partial class Form1 : Form
    {
        ...
        {
            int cod;
            double inss, salarioBruto, horasTrabalhadas, horasExtras, horasExtras2, valorHorasExtras, salarioLiquido, salarioHorasExtras;
            ...
            switch (cod.ToString()){
                case "1": 
                    ...
                    /*---------------------------------------------------*/
                    valorHorasExtras = (horasExtras * 8);
                    horasExtras2 = (valorHorasExtras / 2) + valorHorasExtras;
                    lblHorasExtras.Text = "R$ " + horasExtras2.ToString();
                    /*---------------------------------------------------*/
                    salarioHorasExtras = salarioBruto + horasExtras2;
                    lblSalarioHorasExtras.Text = "R$ " + salarioHorasExtras.ToString();
                    /*---------------------------------------------------*/
                    inss = (11 * salarioBruto) / 100;
                    lblINSS.Text = "R$ " + inss.ToString();
                    /*---------------------------------------------------*/
                    salarioLiquido = salarioBruto + horasExtras2 - inss;
                ...
                case "2":
                    ...
                    lblSalarioBruto.Text = "R$ " + salarioBruto.ToString();
                    /*---------------------------------------------------*/
                    valorHorasExtras = (horasExtras * 10);
                    horasExtras2 = (valorHorasExtras / 2) + valorHorasExtras;
                    lblHorasExtras.Text = "R$ " + horasExtras2.ToString();
                    /*---------------------------------------------------*/
                    salarioHorasExtras = salarioBruto + horasExtras2;
                ...
                case "3":
                    ...
                    lblSalarioBruto.Text = "R$ " + salarioBruto.ToString();
                    /*---------------------------------------------------*/
                    valorHorasExtras = (horasExtras * 12);
                    horasExtras2 = (valorHorasExtras / 2) + valorHorasExtras;
                    lblHorasExtras.Text = "R$ " + horasExtras2.ToString();
                    /*---------------------------------------------------*/
                    salarioHorasExtras = salarioBruto + horasExtras2;
